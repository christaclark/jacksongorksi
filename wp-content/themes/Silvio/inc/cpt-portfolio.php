...
function portfolio_register() {  
	...
	$labels = array(
		'name' => __( 'Portfolio', 'silver' ),
		'singular_name' => __( 'Portfolio Item', 'silver' ),
		'add_new' => __( 'Add New Item', 'silver' ),
		'add_new_item' => __( 'Add New Portfolio Item', 'silver' ),
		'edit_item' => __( 'Edit Portfolio Item', 'silver' ),
		'new_item' => __( 'Add New Portfolio Item', 'silver' ),
		'view_item' => __( 'View Item', 'silver' ),
		'search_items' => __( 'Search Portfolio', 'silver' ),
		'not_found' => __( 'No portfolio items found', 'silver' ),
		'not_found_in_trash' => __( 'No portfolio items found in trash', 'silver' )
	);
...
function portfolio_edit_columns( $portfolio_columns ) {
	$portfolio_columns = array(
		...
		"title" => _x('Title', 'column name', 'portfolioposttype'),
...
function portfolio_icon() { ?>
	    <style type="text/css" media="screen">
	        #menu-posts-portfolio .wp-menu-image {
	            background: url(<?php echo get_template_directory_uri() . '/images/admin/portfolio-icon.png'; ?>) no-repeat 6px 6px !important;
	        }
			#menu-posts-portfolio:hover .wp-menu-image, #menu-posts-portfolio.wp-has-current-submenu .wp-menu-image {
	            background-position:6px -16px !important;
	        }
			#icon-edit.icon32-posts-portfolio {background: url(<?php echo get_template_directory_uri() . '/images/admin/portfolio-32x32.png'; ?>) no-repeat;}
	    </style>
	<?php } 
